...
const {
  xprismaMiddleware,
} = require("../middleware/control_estado_middleware");
const {
  hospitalController,
...
router.get(
  ...
  decodeToken,
  xprismaMiddleware,
  departamentoController.getAlldepartamento
);
router.post(
  "/departamento",
  decodeToken,
...
router.get(
  ...
  decodeToken,
  xprismaMiddleware,
  municipioController.getAllCentro
);
...
router.get(
  ...
  decodeToken,
  xprismaMiddleware,
  provinciaController.getAllProvincia
);
